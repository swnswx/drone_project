...
class Yolov8Node(LifecycleNode):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter("model", "/home/sw/detection_ws/safety_equipment.pt")
    ...
    # Load parameters
        ...
        self.get_logger().info(f"Model path: {self.model}")
        self.get_logger().info(f"Device: {self.device}")
        self.get_logger().info(f"Threshold: {self.threshold}")
        self.get_logger().info(f"Enable: {self.enable}")
        self.get_logger().info(f"Image Reliability: {self.reliability}")
